<?php $secciones = $tecnicos->listarSecciones(); ?>
<div class="box-principal">
<h3 class="titulo">Editar tecnico <?php echo $datos['nombre']; ?><hr></h3>
	<div class="panel panel-success">
	  <div class="panel-heading">
	    <h3 class="panel-title">Editar tecnico <?php echo $datos['nombre']; ?></h3>
	  </div>
	  		...
	  		<div class="col-md-9">
	  			<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
				    <div class="form-group">
				      <label for="inputEmail" class="control-label">Nombre del tecnico</label>
				    ...
				    <div class="form-group">
				      <label for="inputEmail" class="control-label">Calificacion</label>
				        <input class="form-control" value="<?php echo $datos['calificacion']; ?>" name="promedio" type="number" required>
				    </div>
				    <div class="form-group">
